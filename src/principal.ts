...
const invitado1: Cl_invitado = new Cl_invitado("Liz",5,0);
const invitado2: Cl_invitado = new Cl_invitado("Juan",0,10);
const invitado3: Cl_invitado = new Cl_invitado("Carla",5,20);
const invitado4: Cl_invitado = new Cl_invitado("Luis",10,10);
const anfitrion: Cl_anfitrion = new Cl_anfitrion();
...
`;
} else console.error("No se pudo encontrar el elemento con el id 'salida'.")